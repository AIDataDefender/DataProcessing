...
- Run b1_GraphExtractor - to use Slither create CFG, IR ; and solc for AST; module auto install solc and npm libraries
- Run e5_preprocess_data - to process as follows:
